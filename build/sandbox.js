...
var UpdateOptions = /* @__PURE__ */ function() {
  function UpdateOptions2(value0) {
    this.value0 = value0;
  }
  ;
  UpdateOptions2.create = function(value0) {
    return new UpdateOptions2(value0);
  };
  return UpdateOptions2;
}();
var renderProgramOutput = function(v) {
  return div_([div_([label_([text("Exit code:")]), text(show2(v.exitCode))]), div_([label_([text("Standard output:")]), pre_([samp_([text(v.stdout)])])]), div_([label_([text("Standard error:")]), pre_([samp_([text(v.stderr)])])])]);
};
var render = function(formComponent) {
  return function(v) {
    return div_([div_([text("Options Form:")]), slot2($$Proxy.value)(unit)(formComponent)(unit)(UpdateOptions.create), button([onClick($$const(RunProgram.value)), type_19(ButtonButton.value), disabled10(isNothing(v.options))])([text("execute program")]), div_([text("Program Output:")]), maybe(text(""))(function($27) {
      return fromPlainHTML(renderProgramOutput($27));
    })(v.programOutput)]);
  };
};
var initialState = /* @__PURE__ */ function() {
  return {
    options: Nothing.value,
...
var handleAction = function(v) {
  ...
  ;
  throw new Error("Failed pattern match at Sandbox.Component (line 90, column 16 - line 94, column 46): " + [v.constructor.name]);
};
var component = function(formComponent) {
  return mkComponent({
...
var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
  return runUI2(component(commandFormComponent))(unit)(body2);
}));
export {
  main2 as main
};
