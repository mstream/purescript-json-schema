...
let
  sources = {
    ...
    "conventional-recommended-bump-9.0.0" = {
      ...
      version = "9.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/conventional-recommended-bump/-/conventional-recommended-bump-9.0.0.tgz";
        sha512 = "HR1yD0G5HgYAu6K0wJjLd7QGRK8MQDqqj6Tn1n/ja1dFwBCE6QmV+iSgQ5F7hkx7OUR/8bHpxJqYtXj2f/opPQ==";
      };
    };
    "cosmiconfig-8.3.6" = {
      name = "cosmiconfig";
    ...
    "release-it-17.0.1" = {
      ...
      src = fetchurl {
        ...
        sha512 = "XHeirIW8ptkkrH1+uCg+ditclZJbSKeovrtIb42v3s2S/icF2xCTwFHpbvAKQGqBVJ5Zm49If8bwsryi247KdQ==";
      };
    };
    "resolve-1.22.8" = {
      name = "resolve";
...
in
{
  "@release-it/conventional-changelog-8.0.1" = nodeEnv.buildNodePackage {
    name = "_at_release-it_slash_conventional-changelog";
    packageName = "@release-it/conventional-changelog";
    version = "8.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@release-it/conventional-changelog/-/conventional-changelog-8.0.1.tgz";
      sha512 = "pwc9jaBYDaSX5TXw6rEnPfqDkKJN2sFBhYpON1kBi9T3sA9EOBncC4ed0Bv3L1ciNb6eqEJXPfp+tQMqVlv/eg==";
    };
    dependencies = [
      ...
      sources."conventional-recommended-bump-9.0.0"
