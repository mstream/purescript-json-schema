...
let
  ...
  # docs-sandbox is a Local package in (Local "./../../lib/purescript-docs-sandbox")
    ...
    "dom-indexed" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          sha256 = "14jz29zpv2mzwiw2py87vf99mlhzyv7vx2yf2n7jy08ri0kxwsz0";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
  ...
  # json-schema is a Local package in (Local "./../../lib/purescript-json-schema")

  # json-schema-cli is a Local package in (Local "./../../lib/purescript-json-schema-cli")
  ...
  # optparse is a Local package in (Local "./../../lib/purescript-optparse")
