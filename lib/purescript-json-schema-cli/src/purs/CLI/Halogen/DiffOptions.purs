module CLI.Halogen.DiffOptions (component) where
...
component ∷ ∀ m. CommandComponent Diff.Options m
...
initialState ∷ Unit → Command.State Diff.Options
initialState _ =
...
handleOptionAction
  ∷ ∀ m
  . OptionAction
  → Command.CommandComponentMonad OptionAction Diff.Options m Unit
